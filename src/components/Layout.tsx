    ...
    <div className="min-h-screen relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold gradient-text">AI Video Studio</h1>
                  <p className="text-xs text-gray-400">Powered by TwelveLabs</p>
                </div>
              </div>
            </div>
      ...
      <div className="fixed inset-0 pointer-events-none">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-emerald-500/20 rounded-full animate-pulse-slow"
            style={{
              left: `${20 + i * 15}%`,
              top: `${10 + i * 10}%`,
